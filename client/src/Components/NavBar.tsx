    ...
    return (
        <div className={classes['NavBar']}>
                                ...
                                <div className={classes['NavBar-burger-sidebar-items']}>
                                    ...
                                    {width < 520 &&
                                        <div className={classes['NavBar-burger-sidebar-items-message']}>
                                            <UIButton type={"primary-small"} onClick={() => window.open('mailto:orders@armtaktika.ru','_self')}>Напишите нам</UIButton>
                                        </div>
                                    }
                                </div>
                            </div>
            ...
            <div className={classes['NavBar-contact']}>
                <UIButton type={width > 520 ? 'link' : "primary-small"} onClick={() => window.open('tel:+79999999296','_self')}>+7 (999) 999-92-96</UIButton>
                {width > 520 &&
